//
// SideScroller main app class
// - shows Loading and starting an FXML-based JavaFX program
// - most of the application's functionality is in SideScrollController
//
...
Pane pane = null;
Scene scene = null;
static SideScroller app;

// set app to last object created; this is currently not used but the JavaFX runtime
// creates TWO SideScroller objects: on the first it runs init() and then start(), and then
...
public void start(Stage primaryStage)
{
    ...
    FXMLLoader loader;
    java.net.URL location = getClass().getResource("sidescroller.fxml");
    ...
    //SideScrollerController controller = (SideScrollerController) loader.getController();
    // I haven't tried using CSS yet, but the below might work
    // scene.getStylesheets().add("style.css");
    primaryStage.setTitle("SideScroller");
